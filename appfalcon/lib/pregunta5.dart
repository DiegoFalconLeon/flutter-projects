...
class Pregunta5 extends StatefulWidget {
   static const String routeName = "/pregunta5";
    
  @override
  _Pregunta5State createState() => new _Pregunta5State();
}
            ...
            onPressed: (){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) {
                ...
                return Scaffold(
                  ...
                  body: Text("Contador de INGRESOS a la lista infinita: $counting")//ListView(children: title2),
                );
              }));
            }
            ),
